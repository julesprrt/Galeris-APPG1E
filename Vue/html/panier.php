              ...
              <table id="table">
                ...
                <tbody id="all_products">
                  <tr> 
                    <td class="article--name"><div style="margin-right:1rem"><img src="../images/tableau.png"></div> <div>
                      ...
                      <td class="price" style="color: #f6e274;">3000€</td>
                ...
                <tfoot>
                  <tr>
                    ...
                    <td><input  type="number" step="1" id="price_product" value="0" contenteditable></td>
                    <td></td>
            
                    <td><button type="button" id="add_button">Passer la commande</button></td>
                  </tr>
                </tfoot>
              </table>
