...
<head>
    ...
    <link rel="stylesheet" href="Vue/CSS/livraison.css">
    <link rel="stylesheet" href="Vue/CSS/header.css">
    <link rel="stylesheet" href="Vue/CSS/footer.css">
    <script src="Vue/JS/header.js" defer></script>
    <script src="Vue/JS/livraison.js" defer></script>
</head>
        ...
        <section class="livraison">
            ...
            <form class="livraison-form">
                    ...
                    <div class="details">
                        <p>
                            ...
                            <input id="nom" type="text" name="nom"
                                value="<?= htmlspecialchars($livraisonres['nom'] ?? '') ?>" required>
                        </p>
                        <p>
                            <strong>Prénom :</strong>
                            <input id="prenom" type="text" name="prenom"
                                value="<?= htmlspecialchars($livraisonres['prenom'] ?? '') ?>" required>
                        </p>
                        <p>
                            <strong>Pays :</strong>
                            <input id="pays" type="text" name="pays"
                                value="<?= htmlspecialchars($livraisonres['pays'] ?? '') ?>" required>
                        </p>
                        <p>
                            <strong>Adresse Postale :</strong>
                            <input id="adresse" type="text" name="adresseLivraison"
                                placeholder="Commencez à saisir une adresse de livraison..."
                                value="<?= htmlspecialchars($livraisonres['adresse'] ?? '') ?>">
                        </p>
                        <p>
                            <strong>Code postal :</strong>
                            <input id="codepostale" type="text" name="adresse"
                                value="<?= htmlspecialchars($livraisonres['codepostale'] ?? '') ?>">
                        </p>
                        <p>
                            <strong>Ville :</strong>
                            <input id="ville" type="text" name="adresse"
                                value="<?= htmlspecialchars($livraisonres['ville'] ?? '') ?>">
                        </p>
                    </div>
                </div>
                ...
                <div class="actions">
                    <?php
                    if ($livraison === "panier") {
                        echo "<button type='button' class='btn-paiement btn'>Continuer vers le paiement</button>";
