        ...
        <body>
            ...
            <div class="Page">
                ...
                <details>
                    ...
                    <p>Créer un compte Galeris vous donne accès à un monde d’art et d’objets extraordinaires. Dès que
                ...
                <details>
                    ...
                    <p>Il y a différentes méthodes d'achat chez Galeris. Il est possible d'acheter une œuvre lors d'une
                        de nos ventes
                        aux enchères en direct ou en ligne qui se déroulent régulièrement. Voir le calendrier des ventes
                        pour obtenir
                        des informations sur les dates à venir. <br><br>Il est possible d'acquérir des œuvres d'art en
                        utilisant notre site.
                        Service de vente en ligne, offrant des œuvres à l'achat immédiat. Explorez les différentes
                        catégories, explorez quelque
                        chose de nouveau dans nos expositions de vente thématiques ou contactez un expert si vous avez
                        une question particulière en tête.</p>
                </details>

                <details>
                    <summary>Comment m'inscrire à une vente aux enchères ?</summary>
                    <p>Il est nécessaire de créer un compte Galeris et de vérifier votre identité avant de vous
                        inscrire.
                        Après avoir accompli cette étape, vous avez la possibilité de vous inscrire pour participer à
                        n'importe quelle vente aux enchères.<br><br>
                        Pour participer aux enchères en ligne, veuillez vous connecter à votre compte, vous rendre sur
                        la page de vente et cliquer sur le bouton « S'inscrire ».
                        Certaines informations de votre compte, comme votre adresse de livraison préférée, seront
                        nécessaires pour être confirmées.
                        Avant la vente aux enchères ou à tout moment pendant celle-ci, vous avez la possibilité de vous
                        inscrire.</p>
                </details>

                <details>
                    <summary>Comment payer mon achat ?</summary>
                    <p>Si vous remportez une enchère, vous trouverez toutes les informations relatives à votre achat sur
                        votre compte
                        dans l'onglet « Acheter », puis « Finaliser ma commande ».<br><br>

                        Ici, vous pourrez consulter les factures de vos lots, payer et organiser l'expédition des
                        commandes jusqu'à
                        100 000 USD / 100 000 £ / 100 000 € / 1 000 000 HK$ / 100 000 CHF. Veuillez noter qu'il peut
                        s'écouler jusqu'à
                        48 heures avant que les lots soient disponibles pour le paiement en ligne. <br><br>Pour les lots
                        supérieurs à ce montant
                        ou d'autres options de paiement, y compris le virement bancaire, veuillez vérifier le verso de
                        votre facture.</p>
                </details>
                ...
                <details>
                    ...
                    <p>Essayez notre outil gratuit d'estimation d'enchères pour fournir des images et des informations
                        supplémentaires
                        pour chaque article. <br><br>Galeris fournit les estimations d'enchères dans un délai de 3 à 4
                        semaines concernant les articles pour lesquels elle a été sollicitée.
                        Il existe une catégorie de vente qui correspond à notre valeur minimale de consignation.
                        Si vous disposez de plus de six articles à évaluer, nous vous prions de prendre contact avec nos
                        services d'estimation et d'évaluation des successions.</p>
                </details>
                ...
                <details>
                    ...
                    <p>Galeris facture un taux de commission vendeur unique pour les services que nous fournissons.
                        La commission est calculée sur chaque article sous forme de pourcentage fixe basé sur le prix
                        d'adjudication
                        final aux enchères. <br>
                        <br>Ce taux comprend les frais de marketing et la couverture d'assurance. Si votre article se
                        vend au-dessus de l'estimation haute que nous avons convenue avec vous, il y aura également une
                        commission de
                ...
                <details>
                    ...
                    <p>Merci d'avoir envisagé de confier la vente de votre article à Galeris. La première
                        ...
                        si votre article convient à la vente aux enchères de Galeris.<br><br> Un spécialiste de Galeris
                        vous
                        contactera ensuite pour discuter des estimations, vous conseiller sur les dates de vente aux
                        enchères et vous expliquer votre accord de vente ainsi que la structure de
                        commission.<br><br>Après la vente
