...
<head>
    ...
    <link rel="stylesheet" href="Vue/CSS/solde.css">
    <link rel="stylesheet" href="Vue/CSS/header.css">
    <link rel="stylesheet" href="Vue/CSS/footer.css">
    <script src="Vue/JS/header.js" defer></script>
    <script src="Vue/JS/solde.js" defer></script>
...
<Body>
    ...
    <main>
        <div class="solde-form">
            <div class="btn-close-container">
                <button class="close-button" type="submit">X</button>
            </div>
            <p class="title-solde">Transfert</p>
            <input type="text" class="input-solde" name="solde" placeholder="Montant (Maximum : <?= $solde ?> €)"
                max="<?= $solde ?>" min="1.0" />
            <br>
            <p class="error"></p>
            <br>
            <div class="btn-container">
                <button class="solde-button" type="submit">Envoyer</button>
            </div>
        </div>
