...
<head>
    ...
    <script src="Vue/JS/exposeattente.js" defer></script>
        ...
        <section class="droite">
            <section class="profil-section">
                <div class="profil-info">
                    ...
                    <img src="./<?php echo $expose['profil'] ?? 'ImageBD/Profil/avatarbasique.jpg'; ?>"
                        alt="Photo de profil" class="photo-profil">
                    <div class="profil-nom">
                        <strong>Exposition par :
                            <?php echo htmlspecialchars($expose['nom']) . " " . htmlspecialchars($expose['prenom']); ?></strong>
                    </div>
                </div>
            </section>
