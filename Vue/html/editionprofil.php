                ...
                <div class="profil-info">
                    <label for="photo-upload" class="profile-image-label">
                        <img id="preview-image"
                            src="./<?php echo htmlspecialchars($user['photodeprofil'] ?? 'ImageBD/Profil/avatarbasique.jpg'); ?>"
                            alt="Photo de profil" class="profile-image">
                    </label>
                    <input type="file" id="photo-upload" name="profile_photo" accept="image/png, image/jpeg"
                        style="display: none;">
                    ...
                    <div class="details">
                        ...
                        <p>
                            ...
                            <textarea name="description" rows="3"
                                placeholder="Parlez un peu de vous..."><?= htmlspecialchars($user['description'] ?? '') ?></textarea>
                        </p>
                        <p>
                            <strong>Adresse :</strong>
                            <input type="text" id="autocomplete" name="adresse"
                        ...
                        <p class="newsletter-section">
                            ...
                            <label for="newsletter-checkbox">
                                Je souhaite recevoir chaque mois la newsletter de <strong>Galeris</strong> pour rester
                                informé des dernières œuvres, expositions et nouveautés !
                            </label>
                        </p>
                    </div>
                </div>
