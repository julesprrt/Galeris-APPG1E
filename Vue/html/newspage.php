...
<head>
    ...
    <link rel="stylesheet" href="Vue/CSS/newspage.css">
    <link rel="stylesheet" href="Vue/CSS/header.css">
    <link rel="stylesheet" href="Vue/CSS/footer.css">
    <script src="Vue/JS/newspage.js" defer></script>
    ...
    <main>
        <section class="news">
            ...
            <div class="carousel-container">
                ...
                <div class="art-image">
                    <?php foreach ($news['chemin_image'] as $index => $chemin): ?>
                        <img src="./<?php echo htmlspecialchars($chemin); ?>"
                            class="carousel-image <?php echo $index === 0 ? 'active' : ''; ?>"
                            alt="Image de <?php echo htmlspecialchars($news['titre']); ?>">
                    <?php endforeach; ?>
                </div>
                <!-- Flèche droite -->
            ...
            <div class="news-info">
                <p class="info">Publiée le <?php echo htmlspecialchars($news['date_news']); ?> par
                    <?php echo ucfirst(htmlspecialchars($news['nom'])); ?>
                    <?php echo ucfirst(htmlspecialchars($news['prenom'])); ?></p>
