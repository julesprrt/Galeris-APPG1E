...
<head>
    ...
    <script src="https://galeris/Galeris-APPG1E/vue/JS/listeattenteexpose.js" defer></script>
    <title>Liste des exposés en liste d'attente</title>
</head>
        ...
        <header>
            ...
            <nav class="menu">
                <ul>
                    ...
                    <li><a href="https://galeris/Galeris-APPG1E/news">News</a></li>
                    <li><a href="#">Plus</a></li>
                </ul>
            </nav>
