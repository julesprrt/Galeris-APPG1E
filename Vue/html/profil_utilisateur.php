...
<head>
    ...
    <link rel="stylesheet" href="Vue/CSS/profil_utilisateur.css">
...
<body>
    ...
    <main>
        <section class="profil">
            <img src="./<?= htmlspecialchars($user['photodeprofil'] ?? 'ImageBD/Profil/avatarbasique.jpg') ?>"
            ...
            <?php if (!empty($oeuvres)): ?>
                <ul>
                    <?php foreach ($oeuvres as $oeuvre): ?>
                        <li>
                            <img src="./<?= htmlspecialchars($oeuvre['image_path']) ?>"
                                alt="<?= htmlspecialchars($oeuvre['Titre']) ?>" class="oeuvre-image">
