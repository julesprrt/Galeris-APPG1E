...
<head>
    ...
    <link href="./Vue/CSS/ins.css" rel="stylesheet" type="text/css">
        ...
        <div class="Page-content">
            <div class="infos-inscription">
                <div class="inscrivez-vous">
                    <div class="inscription-content">
                        <h1 class="bigTitle">Inscrivez-vous à</h1>
                        <h1 class="text-galeris">Galeris</h1>
                        <p class="simpleBigText">Si vous avez déjà un compte</p>
                        <p class="simpleBigText">vous pouvez vous connecter <a href="./connexion">ici !</a></p>
                    </div>
                </div>
            </div>
            <div class="form-inscription">
                ...
                <input type="password" class="input-user" name="password" placeholder="Mot de passe"
                    title="Veuillez entrer un mot de passe contenant plus de 8 caractères avec au minimum une majuscule, une minuscule, un chiffre et un caractère spécial" />
                ...
                <label class="checkbox-container">
                    ...
                    Je reconnais avoir pris connaissance des <a href="./cgu" target="_blank">conditions générales d’utilisation</a> de Galeris
                </label>
                <br>
