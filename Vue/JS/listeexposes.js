const cbox = document.querySelectorAll(".exposeOBJ");
...
async function saveId(event) {
    const divParent = event.currentTarget.querySelector(".expose");
    ...
    if (statuscode === 200) {
       window.location.href = "https://galeris/Galeris-APPG1E/expose";
    }
}